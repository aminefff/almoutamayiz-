...
import {
    ChevronRight, Calendar, Loader2, Play, Users, List, Quote, Languages,
    ArrowLeft, Sparkles, Sword
} from 'lucide-react';
...
const MatchingGameSelectionScreen: React.FC<MatchingGameSelectionScreenProps> = ({ onStartGame, onBack }) => {
    ...
    const handleStartGame = async () => {
        ...
        try {
            ...
            المحتوى: ${contentText.substring(0, 30000)}`; // Increased limit
            ...
            const items: MatchItem[] = JSON.parse(cleanJson);
